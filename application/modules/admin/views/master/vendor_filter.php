		...
		<div class="card-body">
			<div class="card">
				<div class="card-header">
					...
					<!-- <a class="btn btn-outline-dark btn-lg col-2 pull-right" href="<?php echo base_url('vendor_excel_import')?>"><i class="fa fa-plus" aria-hidden="true"></i> Add Bulk Vendor</a> -->
                    <a class="btn btn-outline-dark btn-lg col-2 pull-right" href="<?php echo base_url('vendor_add')?>"><i class="fa fa-plus" aria-hidden="true"></i> Add Vendor</a>
							...
							<?php if(!empty($vendors)):?>
    							<?php $sno = 1; foreach ($vendors as $vendor):?>
    								<tr>
    									...
    									<a href="<?php echo base_url();?>vendor_profile/edit?id=<?php echo base64_encode(base64_encode($vendor['id'])); ?>" class="mr-2  " > <i	class="fas fa-pencil-alt"></i>
    									</a>
