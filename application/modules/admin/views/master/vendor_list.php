...
<div class="row">
	<div class="col-12">
		...
		<!-- <a class="btn btn-outline-dark btn-lg col-2" href="<?php echo base_url('vendor_excel_import')?>"><i class="fa fa-plus" aria-hidden="true"></i> Add Bulk Vendor</a> -->
		<a class="btn btn-outline-dark btn-lg col-2" href="<?php echo base_url('vendor_add')?>"><i class="fa fa-plus" aria-hidden="true"></i> Add Vendor</a>
		<div class="card-body">
			<div class="card">
