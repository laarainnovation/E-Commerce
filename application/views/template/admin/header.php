				...
				<ul class="navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown"
						...
						<div class="dropdown-menu dropdown-menu-right pullDown">
							...
							<a href="<?php echo base_url('profile/r');?>" class="dropdown-item has-icon"><i class="far fa-user" style="font-size: 17px;"></i> Profile
							</a> 
						<?php }else{ 
							?>
<a href="<?php echo base_url();?>vendor_profile/edit?id=<?php echo base64_encode(base64_encode($this->vendor_list_model->fields('id')->where('vendor_user_id',$this->ion_auth->get_user_id())->get()['id']));?>" class="dropdown-item has-icon"><i class="far fa-user" style="font-size: 17px;"></i> Profile
							</a> 
					<?php }?>
