...
<script src="https://maps.googleapis.com/maps/api/js?key=<?=$this->db->get_where('settings', array('key' => 'google_api_key'))->row()->value;?>&libraries=places&callback=initMap"
        async defer></script>
<script type="text/javascript">
           function initMap() {
...
function showposition(position) {
  ...
  var longitude=position.coords.longitude;
   $.ajax({
            url: '<?=base_url('general/common/get_location/');?>'+latitude+'/'+longitude,
            type: 'get',
            success: function(response)
            {
